...
const Orders = () => {
  ...
  const [itemsToShow, setItemsToShow] = useState(dummyOrders)

  // data holding states

  function handleSearch(value) {
    setSearchValue(value)
    setItemsToShow(dummyOrders.filter(el => el.orderFrom.toLowerCase().includes(value.toLowerCase())))
  }
